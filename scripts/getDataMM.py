...
try:
	...
	#print E[44].getText()
	DATA=[]
	appendInFile(20,27,MM_ammonia)
	appendInFile(27,34,MM_benzene)
	appendInFile(34,41,MM_Cmonoxide)
	appendInFile(41,48,MM_Ndioxide)
	appendInFile(48,55,MM_Noxide)
	appendInFile(55,62,MM_oxidesN)
	appendInFile(62,69,MM_ozone)
	appendInFile(69,76,MM_xylene)
	appendInFile(76,83,MM_Sdioxide)
	appendInFile(83,90,MM_toluene)
	print E[107].getText()
